    ...
    def run_batch_evaluation(self, qa_pairs: list, selected_metrics: list, truths_limit: int = None) -> BatchEvaluationResult:
        ...
        correctness = GEval(
            ...
            evaluation_steps=[
                ...
                "Verify claims in the actual output are supported by the provided context.",
            ],
            rubric=[
        ...
        hallucination = GEval(
            name="Hallucination",
            criteria="Does the output match the expected output without adding false claims? Any claim not present in the provided context should be treated as a hallucination.",
            evaluation_params=[
